        ...
        <div className="mt-14 grid grid-cols-1 gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            <p>
              ...
              , distributed systems, system design, and scalable software
              architecture.
            </p>

            <p>
              I enjoy building backend applications involving authentication,
              databases, caching, REST APIs, and real-world systems — turning
              complex requirements into clean, scalable, and maintainable
              solutions.
            </p>
            ...
            <p>
              ...
              , while continuously strengthening my software engineering,
            ...
            <div className="mt-8 flex items-center gap-2 text-sm text-white/55">
              ...
              Open to Software & Backend roles
            </div>
          </motion.div>
